    ...
    <div class="uploader">
        <div class="flex">
            <div class="text-center">
                <button class="btn close-uploader"><i class="icon-backward icon-white"></i> <?php
...
<div class="container-fluid">
	...
	<li><small class="hidden-phone">(<span id="files_number"><?php echo $current_files_number."</span> ".trans('Images');?>)</small></li>

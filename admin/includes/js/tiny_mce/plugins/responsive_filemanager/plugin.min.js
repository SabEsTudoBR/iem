...
tinymce.PluginManager.add('responsivefilemanager', function(editor) {
	...
	function openmanager() {
		...
		const fileUrl = editor.settings.external_filemanager_path+'dialog.php?userID=' + e.settings.imgPathTypeId + '&type=4&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.settings.language+'&akey='+akey;
